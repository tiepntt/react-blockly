...
const INITIAL_JSON = {
        ...
        inputs: {
          STACK: {
            block: {
              type: "variables_set",
              id: "r/mJlmqB~/5#-)~UqkAa",
              fields: { VAR: { id: "q@$ZF(L?Zo/z`d{o.Bp!" } },
              inputs: {
                VALUE: {
                  block: {
                    type: "text",
                    id: "M(A3RGOe,Pi:EYPNC-dP",
  ...
  variables: [{ name: "text", id: "q@$ZF(L?Zo/z`d{o.Bp!" }],
};
